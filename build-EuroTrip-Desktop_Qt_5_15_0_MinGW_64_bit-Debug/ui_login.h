...
public:
    ...
    void setupUi(QDialog *login)
    {
        ...
        label_3->setGeometry(QRect(60, 10, 281, 61));
        label_3->setFrameShape(QFrame::Box);
        label_3->setFrameShadow(QFrame::Sunken);
        label_3->setPixmap(QPixmap(QString::fromUtf8("img/Memory_Leak_Logo.png")));
    ...
    void retranslateUi(QDialog *login)
    {
        ...
        pushButton_NewAccount->setText(QCoreApplication::translate("login", "New Account", nullptr));
